# AI Image Prompt Recommender — 11,000+ Nano Banana Pro Prompts

[![Prompts](https://img.shields.io/badge/Prompts-11000%2B-brightgreen)](https://youmind.com/nano-banana-pro-prompts)
...
> **Stop spending hours hunting for the right AI image prompt.** Tell your AI assistant what you need in one sentence — it searches 11,000+ curated Nano Banana Pro prompts and returns the top 3 matches with sample images, ready to use.
>
...
An **AI agent skill** that gives Claude, OpenClaw, Cursor, and other AI assistants the ability to intelligently search a curated library of **11,000+ Nano Banana Pro (Gemini image model) prompts**, recommend the best matches for your use case, and even customize prompts based on your content.
...
- ✅ **11,000+ prompts, organized by use case** — not a random dump, but professionally categorized
...
|----------|-------|-----------|
| Social Media Post | 6,800+ | Instagram, Twitter/X, Facebook, viral content |
| Product Marketing | 4,000+ | Ads, campaigns, promotional materials |
| Profile / Avatar | 1,100+ | Headshots, profile pictures, character portraits |
| Others / Mixed | 950+ | Uncategorized creative prompts |
| Poster / Flyer | 520+ | Events, announcements, banners |
| Infographic | 480+ | Data visualization, educational content |
| E-commerce | 430+ | Product photos, listings, white background |
| Game Asset | 410+ | Sprites, characters, items |
| Comic / Storyboard | 300+ | Manga, panels, sequential art |
| YouTube Thumbnail | 180+ | Click-worthy video covers |
| App / Web Design | 170+ | UI mockups, interface designs |
...
**Token-efficient by design**: The skill never loads full category files. It uses grep-style search to extract only matching prompts, keeping token usage minimal even with 11,000+ prompts in the library.
...
Nano Banana Pro is Google's Gemini image generation model (model ID: `gemini-3.1-flash-image-preview`). It produces high-quality, photorealistic and artistic images from text prompts. [Try it on YouMind →](https://youmind.com/nano-banana-pro-prompts)
